...
<head>
    ...
    <title>India's Largest HR Festival 2025</title>
...
<body>
    <section id="event1">
        <div class="event-header">
            <h3>India's Largest HR Festival 2025</h3>
        </div>

        <div class="event-image1 mt-4">
            <img src="assets/images/HRF2025_BG.jpg" alt="Event Image">
        </div>
        ...
        <div class="row event-details mt-4 flex-lg-row-reverse">
            <div class="col-md-5 mt-3">
                 <div class="icon-text">
                    ...
                    <span>July 05, 2025 - 09:30 AM </span>
                </div>
                <div class="icon-text">
                    <i class="fas fa-map-marker-alt fa-2x"></i>
                    <span>Chennai Trade Centre, Chennai.</span>
                </div>
            ...
            <div class="col-md-7">
                <div class="event-description mb-2 mt-2">
                          <h3>About the Event</h3>
                    <p class="mt-3"  data-aos="fade-right">We're thrilled to announce our upcoming Bengaluru HR Conference 2025! Dive into the world of Human Resources, connect with industry experts!</p>
                    <p class="mt-3" data-aos="fade-left"><b>Networking Opportunities:</b> Connect with like-minded professionals, expand your network, and forge meaningful connections that extend beyond the event. Don't miss this chance to build your professional community.</p>
                    <p class="mt-3" data-aos="fade-left"><b>WHAT TO EXPECT:</b></p>
                    <p data-aos="fade-left"><i class='bx bx-right-arrow-alt'></i> Inspiring Keynote Sessions by industry pioneers</p>
                    <p data-aos="fade-left"><i class='bx bx-right-arrow-alt'></i> Dynamic Panel Discussions on emerging trends</p>
                    <p data-aos="fade-left"><i class='bx bx-right-arrow-alt'></i> Vibrant platform for relationship-building, knowledge sharing, and learning.</p>
        ...
        <h3 class="mt-2 mb-2">Event Highlights</h3>
        </div>
        <iframe width="100%" height="505" src="https://www.youtube.com/embed/KYON0ZqPQMg?si=pNLaY5407cTW0lFg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        </div>
        </div>

        <section id="sponsors_logo" class="sponsor-section" style="margin-top: 1px; padding: 40px 0; background-color:rgba(228, 230, 250, 0.3);">
            <div class="container">
...
<div class="event-description mt-4">
    <h3 class="mt-2 mb-2">Venue</h3>
    <p class="mt-2 mb-2" style="text-align: Center;">The event held at the Chennai Trade Centre, Nandambakkam, Chennai.</p>
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.355520794649!2d80.18673192507713!3d13.013017537306181!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267345cb07d5b%3A0x7d6459212d295bdf!2sChennai%20Trade%20Centre%20-%20Nandambakkam!5e0!3m2!1sen!2sin!4v1751867383641!5m2!1sen!2sin" width="100%" height="350" frameborder="0"  style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
               </div>
    </section>
