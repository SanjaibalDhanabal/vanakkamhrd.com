                    ...
                    if ($members_result->num_rows > 0) {
                        while ($row = $members_result->fetch_assoc()) {
                            ...
                            if (!empty($row["image"]) && file_exists('..uploads/' . $row["image"])) {
                                echo "<img src='..uploads/" . htmlspecialchars($row["image"]) . "' width='50' height='50' alt='Member Image'>";
                            } else {
                                echo "<img src='path/to/default-image.jpg' width='50' height='50' alt='Default Image'>";
                            }
                            echo "</td>";
