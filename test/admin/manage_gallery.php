    ...
    <div class="form-container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <select name="category" id="category" required>
                <option value="hr_meet_2022" <?php echo $edit_row['category'] == 'hr_meet_2022' ? 'selected' : ''; ?>>HR Meet 2022</option>
                <option value="tpo_meet_2023" <?php echo $edit_row['category'] == 'tpo_meet_2023' ? 'selected' : ''; ?>>TPO Meet 2023</option>
                <option value="first_anniversary_awards_2024" <?php echo $edit_row['category'] == 'first_anniversary_awards_2024' ? 'selected' : ''; ?>>First Anniversary & Awards 2024</option>
