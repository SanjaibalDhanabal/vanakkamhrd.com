...
<body>
    <div class="container">
        ...
        <form action="process_selection.php" method="post">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td><input type='checkbox' name='selected_ids[]' value='" . $row["id"] . "'></td>"; // Checkbox for each row
            ...
            <button type="submit" class="btn btn-primary">Send Confirmation Emails</button>
            </div>
        </form>
    </div>
